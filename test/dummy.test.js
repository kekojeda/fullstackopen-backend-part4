...
//         assert.strictEqual(result, null)
//     })
//     test('when the list has only one blog, the author with the most blogs is the author of that blog.', () => {
...
//       assert.strictEqual(result, null)
//   })
//   test('when the list has only one blog, the author with the most likes is the author of that blog..', () => {
